...
const int  SEN_LSS_REF = 1025;//510;
const int  SEN_RSS_REF = 1160;//463;
...
const float  FIX_DISTANCE_L2 = 4.0;		// 左大回り&左行き斜めの壁切れ読み
const float  FIX_DISTANCE_R2 = 5.0;		// 右大回り&右行き斜めの壁切れ読み

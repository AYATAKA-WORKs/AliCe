...
* Return Value : none
*******************************************************************************/
void initClock::CGC_oscillation_main(void) {
...
* Return Value : none
*******************************************************************************/
void initClock::CGC_oscillation_PLL(void) {
...
* Return Value : none
*******************************************************************************/
void initClock::CGC_oscillation_HOCO(void) {
...
* Return Value : none
*******************************************************************************/
void initClock::CGC_no_use_subclk(void) {
    uint8_t i;
...
* Return Value : none
*******************************************************************************/
void initClock::CGC_disable_subclk_RTC_use_mainclk(void) {
    uint8_t i;
    volatile uint8_t dummy;
...
* Return Value : none
*******************************************************************************/
void initClock::CGC_subclk_as_sysclk(void) {
    uint8_t i;
    volatile uint8_t dummy;
...
* Return Value : none
*******************************************************************************/
void initClock::CGC_subclk_as_RTC(void) {
    uint8_t i;
    volatile uint8_t dummy;
...
* Return Value : none
*******************************************************************************/
void initClock::CGC_subclk_as_sysclk_RTC(void) {
    uint8_t i;
    volatile uint8_t dummy;
...
* Return Value : none
*******************************************************************************/
void initClock::disable_subclk(void) {
    uint8_t i;
    volatile uint8_t dummy;
...
* Return Value : none
*******************************************************************************/
void initClock::oscillation_subclk(void) {
    uint8_t i;
    volatile uint8_t dummy;
...
* Return Value : none
*******************************************************************************/
void initClock::no_use_subclk_as_sysclk(void) {
    /* ---- Stop the Sub-clock oscillator ---- */
    /* SOSCCR - Sub-Clock Oscillator Control Register
    b0       SOSTP    - Sub-clock oscillator Stop - Sub-clock oscillator is stopped. */
    SYSTEM.SOSCCR.BYTE = 0x01;
...
* Return Value : none
*******************************************************************************/
void initClock::resetting_wtcr_mainclk(void) {
...
* Return Value : none
*******************************************************************************/
void initClock::resetting_wtcr_subclk(void) {
    /* ---- Stop the Sub-clock oscillator ---- */
    /* SOSCCR - Sub-Clock Oscillator Control Register
    b0       SOSTP    - Sub-clock oscillator Stop - Sub-clock oscillator is stopped. */
    SYSTEM.SOSCCR.BYTE = 0x01;
...
* Return Value : none
*******************************************************************************/
void initClock::enable_RTC(void) {
...
* Return Value : none
*******************************************************************************/
void initClock::disable_RTC_mainclk(void) {
    /* ---- Stop prescaler and counter ---- */
    /* RCR2 - RTC Control Register 2
    b0       START    - start - Prescaler is stopped. */
    RTC.RCR2.BYTE &= 0x7E;
...
* Return Value : none
*******************************************************************************/
void initClock::disable_RTC_subclk(void) {
    uint8_t i;
    volatile uint8_t dummy;
...
*******************************************************************************/
void initClock::cmt0_wait(unsigned int cnt) {
    unsigned int cmt_int_cnt;

...
#define	CSTR_CMT0	CMT.CMSTR0.BIT.STR0
#define	CSTR_CMT1	CMT.CMSTR0.BIT.STR1
#define	CSTR_CMT2	CMT.CMSTR1.BIT.STR2
#define	CSTR_CMT3	CMT.CMSTR1.BIT.STR3
#define CSTR_MTU0	MTU.TSTR.BIT.CST0
#define CSTR_MTU1	MTU.TSTR.BIT.CST1
#define CSTR_MTU2	MTU.TSTR.BIT.CST2
#define CSTR_MTU3	MTU.TSTR.BIT.CST3
#define CSTR_MTU4	MTU.TSTR.BIT.CST4
#define CSTR_TPU0	TPUA.TSTR.BIT.CST0
#define CSTR_TPU1	TPUA.TSTR.BIT.CST1
#define CSTR_TPU2	TPUA.TSTR.BIT.CST2
#define CSTR_TPU3	TPUA.TSTR.BIT.CST3
#define CSTR_TPU4	TPUA.TSTR.BIT.CST4
#define CSTR_TPU5	TPUA.TSTR.BIT.CST5
#define CSTR_TPU6	TPUB.TSTR.BIT.CST6
#define CSTR_TPU7	TPUB.TSTR.BIT.CST7
#define CSTR_TPU8	TPUB.TSTR.BIT.CST8
#define CSTR_TPU9	TPUB.TSTR.BIT.CST9
#define CSTR_TPU10	TPUB.TSTR.BIT.CST10
#define CSTR_TPU11	TPUB.TSTR.BIT.CST11

#define	__CSTR( x )		CSTR ## x
#define	 _CSTR( x )		__CSTR( x )
#define	  CSTR( x )		_CSTR( _ ## x )
